...
export default function Zeyn() {
  ...
  const techStack = ["Electron", "React", "TypeScript", "Local Storage", "Node.js", "Tailwind CSS"];
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-8 mb-16">
        <div className="flex-1">
          <h1 className="mb-4 text-4xl font-bold">Zeyn</h1>
          <p className="text-xl text-[var(--text-muted)] mb-8 leading-relaxed">
            The focus-first editor for novel writers. Stop starting over and finally finish your novel with
            distraction-free tools and smart organization.
          </p>
      ...
      <div className="my-20 p-8 md:p-12 rounded-[var(--radius)] bg-[var(--surface)] text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <StatCard value="2.3M+" label="Words Written" />
            <StatCard value="92%" label="Finish Rate" />
