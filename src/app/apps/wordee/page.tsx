...
export default function Wordee() {
  ...
  const techStack = ["React Native", "AI/ML", "Computer Vision", "Node.js", "Cloud Functions", "Natural Language Processing"];
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-8 mb-16">
        <div className="flex-1">
          <h1 className="mb-4 text-4xl font-bold">Wordee</h1>
          <p className="text-xl text-[var(--text-muted)] mb-8 leading-relaxed">
            An English dictionary on your terms. Learn specific words by taking pictures of textbooks and
            starting effective learning immediately.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              target="_blank"
              className="px-8 py-4 bg-[var(--text)] text-[var(--bg)] font-bold rounded-[var(--radius)] hover:opacity-90 transition-opacity flex items-center justify-center"
            >
      ...
      <div className="my-20 p-8 md:p-12 rounded-[var(--radius)] bg-[var(--surface)] text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <StatCard value="94%" label="Effectiveness" />
            <StatCard value="+127%" label="Memorization" />
